      ...
      <FotterActionItem
        ...
        svg={
          <React.Fragment>
            ...
            <path d="M22.7004 4.60682V9.92317C22.7004 10.1272 22.6194 10.3228 22.4751 10.4671C22.3308 10.6114 22.1352 10.6924 21.9312 10.6924H16.6148C15.9292 10.6924 15.586 9.86404 16.0706 9.37942L21.3874 4.06259C21.872 3.57702 22.7004 3.92125 22.7004 4.60682Z" fill={isClicked === 3 ? '#DF6059' : '#8C8C8C'}/>
