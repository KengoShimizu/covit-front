...
export const ShopForm: React.FC<ShopFormProps> = ({ handleChange, addData }) => {
  ...
  return (
    <div className="container">
      ...
      <Input theme={isOwnerPage && InputThemes.REQUIRED} handleChange={handleChange} label='ふりがな' placeholder='おいしくてあんぜんなおみせ' content={addData.kana_name} name='kana_name' />
      ...
      {isOwnerPage && <Input theme={InputThemes.REQUIRED} handleChange={handleChange} label='電話番号' placeholder='020-0000-0014' content={addData.contact} name='contact' />} 
    </div>
  );
}