...
export const ShopLinkForm: React.FC<ShopLinkFormProps> = ({ handleLinkChange, links }) => {
  ...
  return (
    <div className="container">
      <Input 
        theme={[InputThemes.INIT, InputThemes.SHOP_REGISTRATION]}
        handleChange={handleLinkChange}
        label='ホームページのリンク'
        placeholder='https://www.sample.com/'
        content={links.homepage.url}
        name='homepage'
